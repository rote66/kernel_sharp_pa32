...
#define SHDISP_GC_LUT_ENTRIES                       (256)
...
struct shdisp_gc_lut {
    unsigned char   r_data[SHDISP_GC_LUT_ENTRIES];
    unsigned char   g_data[SHDISP_GC_LUT_ENTRIES];
    unsigned char   b_data[SHDISP_GC_LUT_ENTRIES];
};
