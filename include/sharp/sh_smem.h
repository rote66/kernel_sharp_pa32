...
typedef struct 
{
    ...
    unsigned char       sh_camOtpData[18432];        /* Camera Production adjustment Data */
    ...
    unsigned short      sh_proxgrip_p3max[4];        /* Grip Sensor Count Value 3mm MAX*/
    unsigned short      sh_proxgrip_p3ave[4];        /* Grip Sensor Count Value 3mm AVE*/
    unsigned short      sh_proxgrip_p3min[4];        /* Grip Sensor Count Value 3mm MIN*/
