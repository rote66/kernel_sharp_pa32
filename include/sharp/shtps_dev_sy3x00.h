...
#define TPSDEV_BOOT_FW_UPDATE_CRC_ERROR_CHECK_REQ	_IO ( TPS_IOC_MAGIC, 73)
#define TPSDEV_GET_DOUBLE_TAP_ENABLE	_IOR ( TPS_IOC_MAGIC, 74, int)
#define TPSDEV_GET_CALIBRATION_PARAM	_IOR ( TPS_IOC_MAGIC, 75, struct shtps_ioctl_param)
...
#define COMPAT_TPSDEV_GET_CALIBRATION_PARAM		_IOR ( TPS_IOC_MAGIC, 75, struct shtps_compat_ioctl_param)
