...
/* SHLOCAL_CAMERA_DRIVERS<- */
	...
	conf_sec_array.addr_type = MSM_ACTUATOR_WORD_ADDR;
	conf_sec_array.delay = 0;
	conf_sec_array.reg_setting = &reg_sec_setting;
	conf_sec_array.size = 1;
...
/* SHLOCAL_CAMERA_DRIVERS<- */
	...
	// wait
	client_addr_type = a_ctrl->i2c_client.addr_type;
	a_ctrl->i2c_client.addr_type = MSM_CAMERA_I2C_WORD_DATA;
...
static int __init msm_actuator_init_module(void)
{
	...
	return platform_driver_register(&msm_actuator_platform_driver);
#else
