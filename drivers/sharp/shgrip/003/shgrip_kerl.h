...
#define SHGRIP_IOCTL_GET_SENSOR_COUNT		_IOR (SHGRIP_IOC_MAGIC, 21, struct shgrip_sensor_count)
#define SHGRIP_IOCTL_GET_SENSOR_THRESHOLD	_IOR (SHGRIP_IOC_MAGIC, 22, struct shgrip_thr)
#define SHGRIP_IOCTL_DIAG_BOOT_CHECK_SUM	_IOR (SHGRIP_IOC_MAGIC, 23, unsigned short)
#define SHGRIP_IOCTL_GET_COVER_STATUS		_IOR (SHGRIP_IOC_MAGIC, 24, unsigned char)
#define SHGRIP_IOCTL_GET_HW_REVISION		_IOR (SHGRIP_IOC_MAGIC, 25, unsigned short)
#define SHGRIP_IOCTL_REQUEST_CALIBRATION	_IO  (SHGRIP_IOC_MAGIC, 26)
#define SHGRIP_IOCTL_GET_CALIBRATION_DATA	_IOR (SHGRIP_IOC_MAGIC, 27, struct shgrip_calibration_data)
#define SHGRIP_IOCTL_END_CALIBRATION		_IOW (SHGRIP_IOC_MAGIC, 28, struct shgrip_calibration_info)
...
struct shgrip_prx_reg {
	unsigned char addrs;
	unsigned char value;
};

struct shgrip_dlt_reg {
	unsigned char ch0;
	unsigned char ch1;
	unsigned char ch2;
	unsigned char ch3;
...
struct shgrip_flt_reg {
	unsigned char tg;
	unsigned char tr;
};

struct shgrip_cflt_reg {
	unsigned char tc;
	unsigned char tu;
};

struct shgrip_extdevflt_reg {
	unsigned char te1;
	unsigned char te2;
	unsigned char imtc1;
	unsigned char imtc2;
...
struct shgrip_sens_setting_params {
    struct shgrip_prx_reg com2_val[4];
    struct shgrip_prx_reg com3_val[4];
    struct shgrip_prx_reg com4_val[4];
    struct shgrip_prx_reg ltl_val[4];
    struct shgrip_prx_reg ltm_val[4];
    struct shgrip_prx_reg htl_val[4];
    struct shgrip_prx_reg htm_val[4];
    struct shgrip_dlt_reg dlt_val;
    struct shgrip_cdlt_reg cdlt_val;
    struct shgrip_flt_reg flt_val;
    struct shgrip_cflt_reg cflt_val;
    struct shgrip_extdevflt_reg extdevflt_val;
...
struct shgrip_sensor_count {
    struct shgrip_dcount dcount_sensor[4];
};

struct shgrip_thr {
    struct shgrip_nthr th_h_sensor[4];
    struct shgrip_nthr th_l_sensor[4];
};

struct shgrip_calibration_data {
    unsigned short calib_count_sensor0;
    unsigned short calib_count_sensor1;
    unsigned short calib_count_sensor2;
    unsigned short calib_count_sensor3;
};

struct shgrip_thres_reg {
	unsigned char val[16];
};

struct shgrip_calibration_info  {
	int calib_connect;
	struct shgrip_calibration_data calib_data[16];
	struct shgrip_thres_reg thres;
};
