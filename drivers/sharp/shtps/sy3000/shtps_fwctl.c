...
/* -------------------------------------------------------------------------- */
int shtps_fwctl_set_doze_param(struct shtps_rmi_spi *ts_p, u8 *param_p, u8 param_size)
{
	return ts_p->fwctl_p->fwctl_func_p->set_doze_param_f(ts_p->fwctl_p, param_p, param_size);
}
...
/* -------------------------------------------------------------------------- */
int shtps_fwctl_get_tm_hybrid_adc(struct shtps_rmi_spi *ts_p, u8 tm_mode, u8 *tm_data)
{
	return ts_p->fwctl_p->fwctl_func_p->get_tm_hybrid_adc_f(ts_p->fwctl_p, tm_mode, tm_data);
}

/* -------------------------------------------------------------------------- */
int shtps_fwctl_get_tm_adc_range(struct shtps_rmi_spi *ts_p, u8 tm_mode, u8 *tm_data)
{
	return ts_p->fwctl_p->fwctl_func_p->get_tm_adc_range_f(ts_p->fwctl_p, tm_mode, tm_data);
}
...
/* -------------------------------------------------------------------------- */
int shtps_fwctl_cmd_tm_hybrid_adc(struct shtps_rmi_spi *ts_p, u8 tm_mode)
{
	return ts_p->fwctl_p->fwctl_func_p->cmd_tm_hybrid_adc_f(ts_p->fwctl_p, tm_mode);
}

/* -------------------------------------------------------------------------- */
int shtps_fwctl_cmd_tm_adc_range(struct shtps_rmi_spi *ts_p, u8 tm_mode)
{
	return ts_p->fwctl_p->fwctl_func_p->cmd_tm_adc_range_f(ts_p->fwctl_p, tm_mode);
}
...
/* -------------------------------------------------------------------------- */
int shtps_fwctl_initparam_set_custom_report_rate(struct shtps_rmi_spi *ts_p)
{
	return ts_p->fwctl_p->fwctl_func_p->initparam_set_custom_report_rate_f(ts_p->fwctl_p);
}
...
/* -------------------------------------------------------------------------- */
int shtps_fwctl_set_lpwg_sweep_on(struct shtps_rmi_spi *ts_p, u8 enable)
{
	return ts_p->fwctl_p->fwctl_func_p->set_lpwg_sweep_on_f(ts_p->fwctl_p, enable);
}
/* -------------------------------------------------------------------------- */
int shtps_fwctl_set_lpwg_double_tap(struct shtps_rmi_spi *ts_p, u8 enable)
{
	return ts_p->fwctl_p->fwctl_func_p->set_lpwg_double_tap_f(ts_p->fwctl_p, enable);
}

/* -------------------------------------------------------------------------- */
int shtps_fwctl_glove_enable(struct shtps_rmi_spi *ts_p)
{
	return ts_p->fwctl_p->fwctl_func_p->glove_enable_f(ts_p->fwctl_p);
}

/* -------------------------------------------------------------------------- */
int shtps_fwctl_glove_disable(struct shtps_rmi_spi *ts_p)
{
	return ts_p->fwctl_p->fwctl_func_p->glove_disable_f(ts_p->fwctl_p);
}
