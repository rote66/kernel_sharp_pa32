...
/* --------------------------------------------------------------------------- */
	...
	int shtps_fwctl_set_doze_param(struct shtps_rmi_spi *, u8 *, u8);
	...
	int shtps_fwctl_get_tm_hybrid_adc(struct shtps_rmi_spi *, u8, u8 *);
	int shtps_fwctl_get_tm_adc_range(struct shtps_rmi_spi *, u8, u8 *);
	...
	int shtps_fwctl_cmd_tm_hybrid_adc(struct shtps_rmi_spi *, u8);
	int shtps_fwctl_cmd_tm_adc_range(struct shtps_rmi_spi *, u8);
	...
	int shtps_fwctl_initparam_set_custom_report_rate(struct shtps_rmi_spi *);
	...
	int shtps_fwctl_cover_mode_on(struct shtps_rmi_spi *);
	int shtps_fwctl_cover_mode_off(struct shtps_rmi_spi *);
	int shtps_fwctl_set_custom_report_rate(struct shtps_rmi_spi *, u8 *);
	int shtps_fwctl_set_lpwg_sweep_on(struct shtps_rmi_spi *, u8);
	int shtps_fwctl_set_lpwg_double_tap(struct shtps_rmi_spi *, u8);
	int shtps_fwctl_glove_enable(struct shtps_rmi_spi *);
	int shtps_fwctl_glove_disable(struct shtps_rmi_spi *);
	int shtps_fwctl_set_palm_amplitude_threshold(struct shtps_rmi_spi *, u8);
	void shtps_fwctl_get_palm_amplitude_threshold(struct shtps_rmi_spi *, u8 *);
	int shtps_fwctl_set_palm_area(struct shtps_rmi_spi *, u8);
	void shtps_fwctl_get_palm_area(struct shtps_rmi_spi *, u8 *);
	int shtps_fwctl_set_palm_filter_mode_enable(struct shtps_rmi_spi *);
	int shtps_fwctl_set_palm_filter_mode_disable(struct shtps_rmi_spi *);
