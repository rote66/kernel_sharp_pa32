...
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL0  (576)
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL1  (94)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL0   (0x79)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL1   (0x14)
#define SHDISP_BKL_PWM_LOWER_LIMIT              (0x0011)
#define SHDISP_BKL_PWM_LOWER_LIMIT_ZERO         (0x0011)
...
#define BDIC_REG_OPT2_HT_L_VAL                  (0x22)
#define BDIC_REG_OPT2_HT_H_VAL                  (0x00)
#define BDIC_REG_OPT3_LT_L_VAL                  (0x1E)
#define BDIC_REG_OPT3_LT_H_VAL                  (0x00)
#define BDIC_REG_OPT3_HT_L_VAL                  (0x35)
#define BDIC_REG_OPT3_HT_H_VAL                  (0x00)
#define BDIC_REG_OPT4_LT_L_VAL                  (0x2B)
...
#define BDIC_REG_OPT12_HT_L_VAL                 (0x50)
#define BDIC_REG_OPT12_HT_H_VAL                 (0x09)
#define BDIC_REG_OPT13_LT_L_VAL                 (0x10)
#define BDIC_REG_OPT13_LT_H_VAL                 (0x08)
#define BDIC_REG_OPT13_HT_L_VAL                 (0x65)
#define BDIC_REG_OPT13_HT_H_VAL                 (0x0E)
#define BDIC_REG_OPT14_LT_L_VAL                 (0x7B)
#define BDIC_REG_OPT14_LT_H_VAL                 (0x0C)
#define BDIC_REG_OPT14_HT_L_VAL                 (0x10)
#define BDIC_REG_OPT14_HT_H_VAL                 (0x18)
#define BDIC_REG_OPT15_LT_L_VAL                 (0x30)
#define BDIC_REG_OPT15_LT_H_VAL                 (0x14)
#define BDIC_REG_OPT15_HT_L_VAL                 (0x1B)
#define BDIC_REG_OPT15_HT_H_VAL                 (0x2F)
#define BDIC_REG_OPT16_LT_L_VAL                 (0x85)
#define BDIC_REG_OPT16_LT_H_VAL                 (0x25)
#define BDIC_REG_OPT16_HT_L_VAL                 (0x5B)
#define BDIC_REG_OPT16_HT_H_VAL                 (0x4C)
#define BDIC_REG_OPT17_LT_L_VAL                 (0x85)
#define BDIC_REG_OPT17_LT_H_VAL                 (0x42)
#define BDIC_REG_OPT17_HT_L_VAL                 (0x70)
#define BDIC_REG_OPT17_HT_H_VAL                 (0x6F)
#define BDIC_REG_OPT18_LT_L_VAL                 (0xD0)
#define BDIC_REG_OPT18_LT_H_VAL                 (0x62)
#define BDIC_REG_OPT18_HT_L_VAL                 (0x70)
#define BDIC_REG_OPT18_HT_H_VAL                 (0xA6)
#define BDIC_REG_OPT19_LT_L_VAL                 (0x40)
#define BDIC_REG_OPT19_LT_H_VAL                 (0x91)
#define BDIC_REG_OPT19_HT_L_VAL                 (0x4B)
#define BDIC_REG_OPT19_HT_H_VAL                 (0xE6)
#define BDIC_REG_OPT20_LT_L_VAL                 (0x0F)
#define BDIC_REG_OPT20_LT_H_VAL                 (0x0D)
#define BDIC_REG_OPT20_HT_L_VAL                 (0x18)
#define BDIC_REG_OPT20_HT_H_VAL                 (0x15)
#define BDIC_REG_OPT21_LT_L_VAL                 (0x69)
#define BDIC_REG_OPT21_LT_H_VAL                 (0x12)
#define BDIC_REG_OPT21_HT_L_VAL                 (0x9C)
#define BDIC_REG_OPT21_HT_H_VAL                 (0x22)
#define BDIC_REG_OPT22_LT_L_VAL                 (0x32)
#define BDIC_REG_OPT22_LT_H_VAL                 (0x1D)
#define BDIC_REG_OPT22_HT_L_VAL                 (0x7F)
#define BDIC_REG_OPT22_HT_H_VAL                 (0x30)
#define BDIC_REG_OPT23_LT_L_VAL                 (0x43)
#define BDIC_REG_OPT23_LT_H_VAL                 (0x2C)
