...
#define GPIO_DTV_STDBY_PORTID	8
...
#define VALID_GPIO_DTVRST		GPIO_VALID
...
#define VALID_GPIO_DTV_STDBY	GPIO_INVALID
...
#define IOC_HW_REV_GET		_IOR(TUNERDRV_IOCTL_MAGIC, 0x07, int)
