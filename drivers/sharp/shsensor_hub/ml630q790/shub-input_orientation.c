...
static int32_t input_orien[INDEX_SUM]= {0}; /* SHMDS_HUB_0321_01 add */
...
/* SHMDS_HUB_0321_01 add S */
    ...
    if(input_flg){
        input_orien[4] = shub_local_ts.tv_sec;
        input_orien[5] = shub_local_ts.tv_nsec;
        shub_input_report_orien(input_orien);
    }else{
        DBG_ORI_DATA("not report\n");
    }
/* SHMDS_HUB_0321_01 add E */
