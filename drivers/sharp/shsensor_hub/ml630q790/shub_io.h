...
// SHMDS_HUB_0305_01 mod E
  uint32_t m_sCmdErrRes;   /* SHMDS_HUB_0322_01 add */
  uint32_t m_nLen;
  bool     m_bBoot;
...
struct IoctlDiagRes{
  ...
  int32_t magData[3];
  int32_t baroData[2];  /* SHMDS_HUB_0120_01 add */
};
...
/* SHMDS_HUB_0120_01 add E */
#define SHUB_DIAG_MES_BARO_HWTEST     _IOR(SHUBIO,1036, struct IoctlDiagRes)   /* SHMDS_HUB_0120_05 add */
