...
#define SHUB_EXIF_TWIST_RIGHT       0x0200 /* SHMDS_HUB_2301_01 SHMDS_HUB_2303_01 add */
#define SHUB_EXIF_TWIST_LEFT        0x0400 /* SHMDS_HUB_2301_01 SHMDS_HUB_2303_01 add */
...
/* SHMDS_HUB_0204_02 add S */
    ...
    param.m_iParam[3] = 1;      // SHMDS_HUB_0204_23 add
...
/* SHMDS_HUB_0204_02 mod S */
    ...
    param.m_iParam[11] = 2;
    param.m_iParam[12] = 0; // SHMDS_HUB_0204_23 add
/* SHMDS_HUB_0204_02 mod E */
    ret = shub_set_param(param.m_iType, param.m_iParam);
    if(ret != 0) {
    ...
    param.m_iParam[4] = 2;
    param.m_iParam[5] = 1;
    param.m_iParam[8] = 0x0202; // SHMDS_HUB_2603_03 add SHMDS_HUB_0204_23 mod (0x3E7E->0x0202)
    param.m_iParam[9] = 1;      /* SHMDS_HUB_2603_03 add */
    ret = shub_set_param(param.m_iType, param.m_iParam);
    if(ret != 0) {
...
/* SHMDS_HUB_2603_03 add S */
    ...
    param.m_iParam[1] = 0x01; //SHMDS_HUB_0204_23 mod (0x1F->0x01)
    ret = shub_set_param(param.m_iType, param.m_iParam);
    if(ret != 0) {
...
/* SHMDS_HUB_2603_02 add S */
    ...
    //param.m_iParam[4] = 2;      //SHMDS_HUB_0204_23 add SHMDS_HUB_0204_24 del
    param.m_iParam[5] = 1;      //SHMDS_HUB_0204_23 add
    param.m_iParam[8] = 0x027E; //SHMDS_HUB_0204_24 mod (0x7E->0x027E)
    param.m_iParam[9] = 1;      //SHMDS_HUB_0204_23 add
    ret = shub_set_param(param.m_iType, param.m_iParam);
    if(ret != 0) {
...
/* SHMDS_HUB_0204_06 add S */
    ...
    param.m_iParam[0] = 0;
    param.m_iParam[4] = 5; //SHMDS_HUB_0204_23 add
    ret = shub_set_param(param.m_iType, param.m_iParam);
    if(ret != 0) {
