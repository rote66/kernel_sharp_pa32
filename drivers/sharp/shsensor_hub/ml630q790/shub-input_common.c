...
#define SHUB_GPIO_RST     (80)  /* SHMDS_HUB_0121_01 (93->80) */
#define SHUB_GPIO_REMP    (124) /* SHMDS_HUB_0121_01 (94->124) */
#define SHUB_GPIO_INT0    (119) /* SHMDS_HUB_0121_01 (75->119) */
/* SHMDS_HUB_0115_01 mod S */
#ifdef SHUB_SW_GPIO_INT1
...
static int shub_com_get_input_no(int inp_type)
{
    ...
    case SHUB_INPUT_BARO:        // [COM3] Barometric Pressure	/* SHMDS_HUB_0120_01 add */
...
//     switch(gpio){
//     case SHUB_GPIO_PIN_RESET:
//         pin_config_set("fd510000.pinctrl", "gp-80", config); /* SHMDS_HUB_0121_01 (93->80) */
//         break;
//     case SHUB_GPIO_PIN_BRMP:
//         pin_config_set("fd510000.pinctrl", "gp-124", config); /* SHMDS_HUB_0121_01 (94->124) */
//         break;
//     case SHUB_GPIO_PIN_INT0:
//         pin_config_set("fd510000.pinctrl", "gp-119", config); /* SHMDS_HUB_0121_01 (75->119) */
//         break;
// #ifdef SHUB_SW_GPIO_INT1 /* SHMDS_HUB_0115_01 mod */
//     case SHUB_GPIO_PIN_INT1:
