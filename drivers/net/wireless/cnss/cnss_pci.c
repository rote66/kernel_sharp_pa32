...
/* [WLAN][SHARP] 2016.02.03 Switch NV file when the AP-mode Start */
#ifdef SH_WIFI_CUSTOMIZE
static struct cnss_fw_files FW_FILES_QCA6174_FW_3_0_APMODE = {
"qwlan30.bin", "apwlan30.bin", "otp30.bin", "utf30.bin",
"utfbd30.bin", "epping30.bin", "evicted30.bin"};
#endif /* SH_WIFI_CUSTOMIZE */
/* [WLAN][SHARP] 2016.02.03 Switch NV file when the AP-mode End */
...
/* [WLAN][SHARP] 2016.01.29 Mod for GPIO 46 Start */
    ...
    ret = gpio_direction_input(penv->wlan_bootstrap_gpio);
#endif /* SH_WIFI_CUSTOMIZE */
...
#else /* SH_WIFI_CUSTOMIZE */
					u32 target_type, u32 target_version, int is_apmode)
#endif /* SH_WIFI_CUSTOMIZE */
/* [WLAN][SHARP] 2016.02.03 Switch NV file when the AP-mode End */
{
	if (!pfw_files)
...
#else /* SH_WIFI_CUSTOMIZE */
		if(is_apmode){
			memcpy(pfw_files, &FW_FILES_QCA6174_FW_3_0_APMODE, sizeof(*pfw_files));
		}else{
			memcpy(pfw_files, &FW_FILES_QCA6174_FW_3_0, sizeof(*pfw_files));
		}
#endif /* SH_WIFI_CUSTOMIZE */
